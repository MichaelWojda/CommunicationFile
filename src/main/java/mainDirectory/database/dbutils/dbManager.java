...
public class dbManager {
    ...
    public static final String LAN_DATABASE_ADDRESS="jdbc:h2:file://europe.abb.com/pl/MOSD-Drives_Factory/06_PLPES/320 Dział Zaopatrzenia/Zaopatrzenie baza/BETA/randomDB";
    ...
    public static void createConnectionSource() {
        {
            try {
                connectionSource = new JdbcConnectionSource( LAN_DATABASE_ADDRESS, "admin", "pass");
